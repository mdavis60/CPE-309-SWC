...
public class InputReader {
  ...
  public void readPlanData(String location) throws Exception {
    ...
    DatabaseManager.getInstance().executeTransaction(
        (Session session) -> {
          ...
          for (String[] e : entries) {
            if (!idSet.contains(Integer.parseInt(e[3]))) {
              ...
              StudentPlanData planData = new StudentPlanData(e[0], e[1], e[2],
                  Integer.parseInt(e[3]), e[4], Integer.parseInt(e[5]), e[6],
                  e[7], Integer.parseInt(e[10]), Integer.parseInt(e[11]),
                  Integer.parseInt(e[12]), Integer.parseInt(e[13]),
                  (int) Double.parseDouble(e[14]));
