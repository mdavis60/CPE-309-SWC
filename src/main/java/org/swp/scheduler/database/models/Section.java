...
public class Section extends Model {
  ...
  // For UI testing
  /*
   * private StringProperty course; public StringProperty prof; public
   * StringProperty room; public StringProperty courseComp; public
   * StringProperty dow; public StringProperty startTime; public StringProperty
   * endTime;
   */
  public Section() {
  ...
  public Section(CourseComponent courseComp, Teacher teacher, Room room,
      String dow, String startTime, String endTime) {
  ...
  public CourseComponent getCourseComponent() {
    try {
      if (courseComponent == null) {
        this.courseComponent = (CourseComponent) DatabaseManager.getInstance()
            .getSingle(CourseComponent.class, this.courseComponentId);
      }
  ...
  public Course getCourse() {
    try {
      if (this.course == null) {
        this.course = (Course) DatabaseManager.getInstance().getSingle(
            Course.class, getCourseComponent().courseId);
      }
      return this.course;
    } catch (Exception e) {
      throw new RuntimeException(e);
  ...
  public Teacher getTeacher() {
    try {
      if (teacher == null) {
        this.teacher = (Teacher) DatabaseManager.getInstance().getSingle(
            Teacher.class, this.teacherId);
      }
      return this.teacher;
    } catch (Exception e) {
      throw new RuntimeException(e);
  ...
  public Room getRoom() {
    try {
      if (this.room == null) {
        this.room = (Room) DatabaseManager.getInstance().getSingle(Room.class,
            this.roomId);
      }
      return this.room;
    } catch (Exception e) {
